...
export const SimilarProduct = ({title, imgUrl, productUrl, historyUrl} : {imgUrl : string, title: string, productUrl: string, historyUrl: string}) => {
    ...
    return (
        <div className="flex flex-col gap-8 items-center max-w-[320px]">
            ...
            <Button to={productUrl} onClick={() => handleHistory(historyUrl)}/>
        </div>
    )
}