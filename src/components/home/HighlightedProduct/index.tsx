            ...
            {data &&
                <article id='highlightedProductCard' className='py-14 bg-peru rounded-md overflow-hidden xl:flex xl:pb-0'>
                    ...
                    >
                        {/* Circles Pattern */}
                        <img 
                            src={data.highlightedProduct.patternUrl} 
                            className=" absolute 
                        ...
                        {/* Product Image */}
                        <img 
                            src={media =="mobile" ? data.highlightedProduct.images.mobileUrl 
                                : media == "tablet" ? data.highlightedProduct.images.tabletUrl 
                        ...
                        >   
                            ...
                            {/* button */}
                            <Link 
                                to={data.highlightedProduct.productUrl} 
