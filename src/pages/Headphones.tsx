// Hooks
import { useHeadphonesQuery } from "../hooks/querys/useHeadphonesQuery";
...
const Headphones = () => {
    const { data, isLoading } = useHeadphonesQuery();
    useLoad();
    ...
    return (
        <div className='mx-6 md:mx-10 lg:mx-14 xl:mx-20'>
            ...
            <div className="-mx-6 md:-mx-10 lg:-mx-14 xl:-mx-20">
                <Header />
                <p className="p-8 lg:p-24 font-bold tracking-[2px] text-[28px] text-white text-center uppercase bg-black">
                    headphones
                </p>
            </div>
